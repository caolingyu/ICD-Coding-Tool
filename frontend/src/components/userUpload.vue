...
export default {  
  ...
  methods: {
    ...
    //       this.$store.dispatch("changeTableData2", response)
    //       this.$store.dispatch("changeTableLoading", false)
    //       this.$store.dispatch("changeIfUpload", true)
    //       this.getNER(value)
    //       // this.doDispatch()
    ...
    //   })
    //   .then(response => {
    //       response.state = this.$store.state
    //       console.log(response.state.tableData2.length)
    //       this.$store.dispatch("addNER2", response)
    //       console.log(this.$store.state.tableData2[0][1].ner)
    //       this.doDispatch()
